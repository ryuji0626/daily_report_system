package jp.example.models.validators;
...
public class EmployeeValidator {
	...
	public List<String> validate(Employee e, Boolean codeDuplicateCheckFlag, Boolean passwordCheckFlag) {
    ...
    // 社員番号
    private String validateCode(String code, Boolean codeDuplicateCheckFlag) {
        // 必須入力チェック
        ...
        if(codeDuplicateCheckFlag) {
            long employees_count = employeeRepository.countByCodeEquals(code);
